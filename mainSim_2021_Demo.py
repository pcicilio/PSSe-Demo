...
# documentation, which is located in the PSSe DOCS folder where PSSe is installed.
    ...
    sav = r"""C:\Users\pcicilio\Documents\PSSe_Demo\Demo_Models\%s""" %sav_file    #find .sav file
    out = r"""C:\Users\pcicilio\Documents\PSSe_Demo\Outputs\%s""" %out_file       #name .outx file
    ...
    with silence(output):    
        ...
        if dyr_file != "None":
            dyre = r"""C:\Users\pcicilio\Documents\PSSe_Demo\Demo_Models\%s""" %dyr_file   #find .dyr file
...
def PlotResults(plot_file,POWR,FREQ,VOLT,excel_file,left_limit,right_limit):
    ...
    png_POWR = r"""C:\Users\pcicilio\Documents\PSSe_Demo\Outputs\POWR_%s""" %plot_file
    png_FREQ = r"""C:\Users\pcicilio\Documents\PSSe_Demo\Outputs\FREQ_%s""" %plot_file
    png_VOLT = r"""C:\Users\pcicilio\Documents\PSSe_Demo\Outputs\VOLT_%s""" %plot_file
    xlsx = r"""C:\Users\pcicilio\Documents\PSSe_Demo\Outputs\%s""" %excel_file
